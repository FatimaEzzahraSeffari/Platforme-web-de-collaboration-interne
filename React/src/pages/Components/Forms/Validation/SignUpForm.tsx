                        ...
                        <form action="#!" id="signUp" onSubmit={(event: any) => {
                            ...
                            <div className="mb-4">
                                <input
                                    ...
                                    onChange={validation.handleChange}
                                />
                                <label htmlFor="termsCondition" className="text-sm align-top text-slate-400"> By registering you agree to the OCP LINK <a href="#!" className="underline text-custom-500">Terms of Use</a></label>
                                {

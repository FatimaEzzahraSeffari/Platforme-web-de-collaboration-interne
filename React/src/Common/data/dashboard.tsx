...
// Construct the profile image URL or use undefined if not available
const currentUserProfileImageUrl = currentUser && currentUser.user && currentUser.user.profile_image
...
const storyData = [
    { id: 1, image: currentUserProfileImageUrl, username: "Your story", bgColor: "bg-pink-100 dark:bg-pink-500/20", isActive: true },

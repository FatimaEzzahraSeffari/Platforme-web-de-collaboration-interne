                    ...
                    <form action="#!">
                        <div className="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            <div className="xl:col-span-4">
                                <label htmlFor="inputValueOld" className="inline-block mb-2 text-base font-medium dark:text-gray-400">Old Password*</label>
                            ...
                            <div className="xl:col-span-4">
                                <label htmlFor="inputValueNew" className="inline-block mb-2 text-base font-medium dark:text-gray-400">New Password*</label>
                                <div className="relative">
                            ...
                            <div className="xl:col-span-4">
                                <label htmlFor="inputValue" className="inline-block mb-2 text-base font-medium dark:text-gray-400">Confirm Password*</label>
                                <div className="relative">

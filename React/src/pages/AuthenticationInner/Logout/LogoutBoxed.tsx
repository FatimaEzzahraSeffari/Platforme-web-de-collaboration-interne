...
const LogoutBoxed: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const logout = async () => {
            try {
                ...
                window.location.href = '/auth-login-boxed';
            } catch (error) {
    ...
    document.title = "LogOut | OCPLINK - Collaboration platform";
                            ...
                            <div className="!px-12 !py-12 card-body h-full flex flex-col">
                                <div className="my-auto">
                                    <div className="mt-8 text-center">
                                        ...
                                        <p className="mb-8 text-slate-500 dark:text-zink-200">Thank you for using OCPLINK Platform &#128525;</p>
                                    </div>
                        ...
                        <div className="mx-2 mt-2 mb-2 border-none shadow-none lg:col-span-7 card bg-white/60 dark:bg-zink-500/60">
                            <div className="!px-10 !pt-10 h-full !pb-0 card-body flex flex-col">
                                <div className="flex items-center justify-between gap-3">
                                    <div className="grow">
                                        <Link to="/">
                                            <img src={ocp} alt="" className="hidden h-20 w-30 dark:block" />
                                            <img src={ocp} alt="" className="block h-20 w-30 dark:hidden" />
                                        </Link>
                                    </div>

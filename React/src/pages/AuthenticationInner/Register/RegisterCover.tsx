...
const RegisterCover = () => {
    ...
    document.title = "Register | OCP LINK - Collaboration platform";
            ...
            <div className="mb-0 border-none lg:w-[500px] card bg-white/70 shadow-none dark:bg-zink-500/70">
                <div className="!px-10 !py-12 card-body">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <p className="text-slate-500 dark:text-zink-200">Get your free OCP LINK  account now</p>
                    </div>
                    ...
                    <form action="/" className="mt-10" id="registerForm">
                        ...
                        <p className="italic text-15 text-slate-500 dark:text-zink-200">By registering you agree to the OCP LINK  <a href="#!" className="underline">Terms of Use</a></p>
                        <div className="mt-10">

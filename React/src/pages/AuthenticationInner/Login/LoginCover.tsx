...
const LoginCover = () => {
    ...
    document.title = "Sign In | OCP LINK - Collaboration platform";
            ...
            <div className="mb-0 border-none lg:w-[500px] card bg-white/70 shadow-none dark:bg-zink-500/70">
                <div className="!px-10 !py-12 card-body">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        <p className="text-slate-500 dark:text-zink-200">Sign in to continue to OCP LINK - Collaboration platform.</p>
                    </div>

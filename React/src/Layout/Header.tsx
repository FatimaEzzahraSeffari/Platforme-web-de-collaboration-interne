...
const [users, setUser] = useState<User | null>(null);
  ...
  useEffect(() => {
    ...
    return (
        <React.Fragment>
            <header id="page-topbar" className="dark:bg-zink-500  dark:border-zink-500 ltr:md:left-vertical-menu rtl:md:right-vertical-menu group-data-[sidebar-size=md]:ltr:md:left-vertical-menu-md group-data-[sidebar-size=md]:rtl:md:right-vertical-menu-md group-data-[sidebar-size=sm]:ltr:md:left-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:md:right-vertical-menu-sm group-data-[layout=horizontal]:ltr:left-0 group-data-[layout=horizontal]:rtl:right-0 fixed right-0 z-[1000] left-0 print:hidden group-data-[navbar=bordered]:m-4 group-data-[navbar=bordered]:[&.is-sticky]:mt-0 transition-all ease-linear duration-300 group-data-[navbar=hidden]:hidden group-data-[navbar=scroll]:absolute group/topbar group-data-[layout=horizontal]:z-[1004]">
                <div className="dark:bg-zink-500  dark:border-zink-500 layout-width">
                    <div className="dark:bg-zink-500  dark:border-zink-500 flex items-center px-4 mx-auto bg-topbar border-b-2 border-topbar group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:border-topbar-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:border-topbar-brand shadow-md h-header shadow-slate-200/50 group-data-[navbar=bordered]:rounded-md group-data-[navbar=bordered]:group-[.is-sticky]/topbar:rounded-t-none group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:border-zink-700 dark:shadow-none group-data-[topbar=dark]:group-[.is-sticky]/topbar:dark:shadow-zink-500 group-data-[topbar=dark]:group-[.is-sticky]/topbar:dark:shadow-md group-data-[navbar=bordered]:shadow-none group-data-[layout=horizontal]:group-data-[navbar=bordered]:rounded-b-none group-data-[layout=horizontal]:shadow-none group-data-[layout=horizontal]:dark:group-[.is-sticky]/topbar:shadow-none">
                        <div className="dark:bg-zink-500 dark:border-zink-500 flex items-center w-full group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl navbar-header group-data-[layout=horizontal]:ltr:xl:pr-3 group-data-[layout=horizontal]:rtl:xl:pl-3">

                            <div className=" dark:border-zink-500 items-center justify-center hidden px-5 text-center h-header group-data-[layout=horizontal]:md:flex group-data-[layout=horizontal]:ltr::pl-0 group-data-[layout=horizontal]:rtl:pr-0">
                                <Link to="/">
                                    <span className="hidden">
                                        <img src="{ocp}" alt="" className="h-6 mx-auto" />
                                    </span>
...
<Dropdown className="relative flex items-center h-header">
      ...
      >
        <div className="bg-pink-100 rounded-full">
          <img src={'https://icon-library.com/images/admin-icon-png/admin-icon-png-20.jpg'} alt="User Profile" className="size-[37.5px] rounded-full" />
        </div>
      </Dropdown.Trigger>
      <Dropdown.Content
        placement="right-end"
      ...
      >
        <h6 className="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">Welcome to OCPLINK</h6>
        <a href="#!" className="flex gap-3 mb-3">
          ...
          <div>
            <h6 className="mb-1 text-15">{users?.name || "admin"}</h6>
            <p className="text-slate-500 dark:text-zink-300">{users?.name} </p>
          </div>
        </a>
        <ul>
          {/* <li>
            <a
              ...
              href="/user-profile"
            >
              <User2 className="inline-block size-4 ltr:mr-2 rtl:ml-2" /> Profile
            </a>
          </li> */}
          {/* <li>
            <a
              ...
              href="/apps-chat"
            >
              <Mail className="inline-block size-4 ltr:mr-2 rtl:ml-2" /> Inbox
              <span className="inline-flex items-center justify-center size-5 ltr:ml-2 rtl:mr-2 text-[11px] font-medium border rounded-full text-white bg-red-500 border-red-500">15</span>
            </a>
          </li> */}
          <li className="pt-2 mt-2 border-t border-slate-200 dark:border-zink-500">
            <a
              ...
              href="/logout"
            >
              <LogOut className="inline-block size-4 ltr:mr-2 rtl:ml-2" /> Sign Out
            </a>
          </li>
        </ul>
      </Dropdown.Content>

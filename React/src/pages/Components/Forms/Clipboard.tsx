...
const FormClipboard = () => {
    ...
    const [values, setValue] = React.useState<string>("Welcome to OCP LINK - Collaboration platform😊");
    const [clipboard1, setClipboard1] = React.useState<string>("Welcome to OCP LINK - Collaboration platform😊");

...
import Calendar1 from "pages/SocialMedia/Calendar";
...
const authProtectedRoutes: Array<RouteObject> = [
  ...
  { path: "/dashboards-admin", component: ListUsers },
  ...
  { path: "/apps-favouris", component: FavorisComponent },
 ...
 // { path: "/apps-calendar-multi-month-stack", component: MultiMonthStack },
  ...
  // Social Media
   ...
   { path: "/apps-social-calendar", component: Calendar1 },
  // Invoices
  // Users
...
const publicRoutes = [
  ...
  { path: "/logout", component: LogoutBoxed },

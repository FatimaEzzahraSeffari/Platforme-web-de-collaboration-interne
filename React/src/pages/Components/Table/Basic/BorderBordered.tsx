                        ...
                        <table className="w-full">
                            ...
                            <tbody className="">
                                ...
                                <tr>
                                    ...
                                    <td className="px-3.5 py-2.5 border border-custom-500 dark:border-custom-800">OCP LINK</td>
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="">
                                ...
                                <tr>
                                    ...
                                    <td className="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">OCP LINK</td>
